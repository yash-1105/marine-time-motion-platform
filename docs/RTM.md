...
| DELAY-UI-001 | FRD §§4.3–4.4 delay analysis | Expose leg-scoped Pilotage, Berthing, Towage Wait, Tug/Towage and Anchorage delay summaries from governed backend timestamps; expose service-duration min/max only when governed start/end timestamps exist. | `apps/api/services/delays/service.py`, `apps/web/src/app/delays/page.tsx` | `test_service_delay_overview_and_duration_ranges_are_governed_and_leg_scoped`, frontend lint/typecheck/build | IMPLEMENTED |
